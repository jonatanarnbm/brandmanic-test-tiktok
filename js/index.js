...
const renderUserData = (json) => {
  ...
  $("#avatar_url--data").text(`<a href="${json['data']['user']["avatar_url"]}">${json['data']['user']["avatar_url"]}</a>`);
  $("#avatar_url100--data").text(`<a href="${json['data']['user']["avatar_url_100"]}">${json['data']['user']["avatar_url_100"]}</a>`);
  $("#avatar_large_url--data").text(`<a href="${json['data']['user']["avatar_large_url"]}">${json['data']['user']["avatar_large_url"]}</a>` );
  ...
  $("#profile_deep_link--data").text(`<a href="${json['data']['user']["profile_deep_link"]}">${json['data']['user']["profile_deep_link"]}</a>`);
